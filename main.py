...
<main>
    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <header>
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-6 fw-normal text-body-emphasis">FAQ</h1>
                </div>
            </header>
            <p>
            ...
            <div style="min-height: 700px;">
                <div class="collapse collapse-horizontal" id="collapseWidthExample1">
                    <div class="card card-body">
                        Чтобы оформить заказ надо:
                        1) Зайти в раздел "Категории" в левом верхнем углу нашего меню,
                        2) Выбрать товары, которые вам понравились и нажать кнопку "Добавить в корзину",
                        3) После, заходите в корзину и нажимаете "Оформить заказ", далее заполняете свои данные.
                    </div>
                </div>
                <div class="collapse collapse-horizontal" id="collapseWidthExample2">
                    <div class="card card-body">
                        При оформлении заказа, важно, указать пункт выдачи, в котором вам будет удобнее забрать посылку.
                    </div>
                </div>
                <div class="collapse collapse-horizontal" id="collapseWidthExample3">
                    <div class="card card-body">
                        Гарантия на возврат - 2 недели, гарантия на товар - 3 месяца.
                    </div>
                </div>
        </main>
    </div>
